...
function displayBooks() {
    $.ajax({
        url: "http://localhost:8080/CL_Workshop_5_war_exploded/books/",
        data: {},
        type: "GET",
        dataType: "json"
    ...
    for (var i = 0; i < titles.length; i++) {
        titles.eq(i).on("click", function () {
            ...
            if (div.is(":visible")) {
                ...
                $.ajax({
                    url: "http://localhost:8080/CL_Workshop_5_war_exploded/books/" + $(this).data("id"),
                    data: {},
                    type: "GET",
                    dataType: "json"
                }).done(function(result) {
...
function activateEditButtons() {
    ...
    for (var i = 0; i < edits.length; i++) {
        edits.eq(i).on("click", function () {
            ...
            $.ajax({
                url: "http://localhost:8080/CL_Workshop_5_war_exploded/books/" + bookId,
                data: {},
                type: "GET",
                dataType: "json"
            }).done(function(result) {
